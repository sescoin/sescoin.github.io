...
const appAmbiances = <AppAmbiance>[
  AppAmbiance(
    ...
    lightScaffold: Color(0xFFFCEAF2),
    lightInput: Color(0xFFF8D6E6),
    darkScaffold: Color(0xFF1E0912),
    darkSurface: Color(0xFF2D0F1F),
    darkCard: Color(0xFF3A1429),
    darkInput: Color(0xFF551E3C),
  ),
  AppAmbiance(
    key: 'frost',
    label: 'Givre',
